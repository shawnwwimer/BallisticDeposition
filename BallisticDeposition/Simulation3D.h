...
uint16_t traversePathRealTime(int32_t* src, int32_t* dest, uint16_t* collision, int8_t* grid, uint16_t L, uint16_t H, int nearest_neighbor = 0, Surface3D* surface = nullptr);
